  ...
  return (
    <div className="terms-and-conditions-body">
      <div className="container terms-and-conditions">
        ...
        <p>Welcome to BG SHOOTING INSTRUCTION!</p>

        <p>
          These terms and conditions outline the rules and regulations for the
          use of BG-SI's Website, located at{" "}
          <NavLink to="/">https://www.bg-si.fr/</NavLink> .
        </p>

        <p>
          By accessing this website we assume you accept these terms and
          conditions. decline terms and conditions or do not continue to use BG
          SHOOTING INSTRUCTION if you do not agree to take all of the terms and
        ...
        <p>
          We employ the use of cookies. By accessing BG SHOOTING INSTRUCTION,
          you agreed to use cookies in agreement with the BG-SI's Privacy
          Policy.{" "}
        </p>
        ...
        <p>
          Unless otherwise stated, BG-SI and/or its licensors own the
          intellectual property rights for all material on BG SHOOTING
          INSTRUCTION. All intellectual property rights are reserved. You may
          access this from BG SHOOTING INSTRUCTION for your own personal use
          subjected to restrictions set in these terms and conditions.
        </p>

        <p>You must not:</p>
        <ul>
          <li>Republish material from BG SHOOTING INSTRUCTION</li>
          <li>
            Sell, rent or sub-license material from BG SHOOTING INSTRUCTION
          </li>
          <li>
            Reproduce, duplicate or copy material from BG SHOOTING INSTRUCTION
          </li>
          <li>Redistribute content from BG SHOOTING INSTRUCTION</li>
        </ul>
        ...
        <p>
          ...
          BG-SI does not filter, edit, publish or review Comments prior to their
          presence on the website. Comments do not reflect the views and
          opinions of BG-SI,its agents and/or affiliates. Comments reflect the
          views and opinions of the person who post their views and opinions. To
          the extent permitted by applicable laws, BG-SI shall not be liable for
        ...
        <p>
          BG-SI reserves the right to monitor all Comments and to remove any
        ...
        <p>
          You hereby grant BG-SI a non-exclusive license to use, reproduce, edit
        ...
        <p>
          ...
          the hyperlink compensates the absence of BG-SI; and (d) the link is in
        ...
        <p>
          ...
          sending an e-mail to BG-SI. Please include your name, your
        ...
        <p>
          No use of BG-SI's logo or other artwork will be allowed for linking
        ...
        <div className="terms-and-conditions-footer">
          ...
          <span className="copyright bg-brand">
            © BG SHOOTING INSTRUCTION {new Date().getFullYear()}
          </span>
        </div>
      </div>
    </div>
