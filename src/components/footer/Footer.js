...
export default function Footer() {
  return (
    ...
    <footer className="footer fixed-bottom d-flex justify-content-around align-items-center py-1 border-top">
      <NavLink to="/">
        <img
          src={logo}
          width="40"
      ...
      <NavLink
        className="Termes-and-conditions-link-footer"
      ...
      {/* <ul className="nav justify-content-end list-unstyled d-flex me-3">
        ...
        <li className="ms-3">
          <a
            ...
            href="https://instagram.com/team_france_geco?utm_medium=copy_link"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="16"
        ...
        <li className="ms-3">
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            href="https://www.facebook.com/bertrand.guillaume.5"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="16"
